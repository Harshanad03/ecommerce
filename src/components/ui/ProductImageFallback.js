...
const ProductImageFallback = ({ name, category = 'other', className = '' }) => {
  ...
  return (
    <div className={`flex items-center justify-center ${getColorByCategory(category)} ${className}`}>
      {firstLetter ? (
        <span className="text-2xl font-bold text-gray-700">{firstLetter}</span>
      ) : (
